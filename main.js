import { inject as injectStyle, dropzone, invoice } from './lib.js'
import './style.css'

document.querySelector('#app').innerHTML = `
  <h1>Hello Vite!</h1>
  <a href="https://vitejs.dev/guide/features.html" target="_blank">Documentation</a>
  <!--<sa-dropzone allow="image/*">
...
//import('./css/table.css').then(value => document.getElementById('invoice').styleScoped = value['default'])
injectStyle(document.getElementById('invoice'), './css/table.css')
